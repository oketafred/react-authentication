...
export default function Dashboard() {
    ...
    return (
      <div>
          <header
            className="rounded-lg mb-6 bg-white border border-gray-200/50 bg-opacity-50 shadow-2xl shadow-gray-600/10 lg:h-full">
              <div className="mx-auto max-w-screen-xl px-4 py-4 sm:py-4 sm:px-6 lg:px-8">
          ...
          <div
            className="mt-6 p-6 sm:p-8 rounded-3xl bg-white border border-gray-200/50 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 bg-opacity-50 shadow-2xl shadow-gray-600/10 lg:h-full">
              <svg
                className="m-auto w-40"
                viewBox="0 0 56 56"
                fill="none"
